...
const TankValves = observer(({
  ...
  return (
    <G>
      ...
      <BigValve X={X + 20} Y={Y + 15} ContentColor={ContentColor} Valve={IntakeValve} />
      ...
      <BigValve X={X + 230} Y={Y + 165} ContentColor={ContentColor} Valve={OutletValve} />
      {/* Drain */}
      ...
      <BigValve X={X + 30} Y={Y + 152} ContentColor={ContentColor} Valve={DrainValve} />
