...
const TankValves = observer(({
  ...
  return (
    <G>
      ...
      <BigValve X={X + 20} Y={Y + 15} isOpen={IntakeValve.Content() !== 0} cb={() => { IntakeValve.Toggle() }} OpenColor={ContentColor} />
      ...
      <BigValve X={X + 230} Y={Y + 165} isOpen={OutletValve.Content() !== 0} cb={() => { OutletValve.Toggle() }} OpenColor={ContentColor} />
      {/* Drain */}
      ...
      <BigValve X={X + 30} Y={Y + 152} isOpen={DrainValve.Content() !== 0} cb={() => { DrainValve.Toggle() }} OpenColor={ContentColor} />
