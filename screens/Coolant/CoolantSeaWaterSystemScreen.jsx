    ...
    <SimulatorScreen>
      <View style={{ flex: 1, flexDirection: 'column' }}>
        <Svg width="100%" height="100%">
          ...
          <Pipe x1={182} y1={506} x2={672} y2={506} ContentColor={CstResourceColor.SeaWater} Size={20} HasContent={SeaChestLowSuctionIntakeValve.isOpen || SeaChestHighSuctionIntakeValve.isOpen} />
          ...
          <Pipe x1={666} y1={430} x2={666} y2={496} ContentColor={CstResourceColor.SeaWater} Size={12} HasContent={SeaChestLowSuctionIntakeValve.isOpen || SeaChestHighSuctionIntakeValve.isOpen} />
          ...
          <Pipe x1={327} y1={300} x2={673} y2={300} ContentColor={CstResourceColor.SeaWater} Size={20} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning || AuxPump.isRunning} />
          <Pipe x1={673} y1={300} x2={894} y2={300} ContentColor={CstResourceColor.SeaWater} Size={20} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning} />

          <Pipe x1={666} y1={310} x2={666} y2={360} ContentColor={CstResourceColor.SeaWater} Size={12} HasContent={AuxPump.isRunning} />
          ...
          <Pipe x1={359} y1={250} x2={359} y2={290} Size={10} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning || AuxPump.isRunning} />
          ...
          <Pipe x1={589} y1={250} x2={589} y2={290} Size={10} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning || AuxPump.isRunning} />
          ...
          <Pipe x1={889} y1={250} x2={889} y2={290} Size={10} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning} />
          ...
          <Pipe x1={295} y1={54} x2={295} y2={152} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning || AuxPump.isRunning} />
          <Pipe x1={525} y1={54} x2={525} y2={152} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning || AuxPump.isRunning} />
          <Pipe x1={820} y1={54} x2={820} y2={152} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning} />

          <Pipe x1={250} y1={50} x2={530} y2={50} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning || AuxPump.isRunning} />
          <Pipe x1={530} y1={50} x2={824} y2={50} ContentColor={CstResourceColor.SeaWater} HasContent={SuctionPump1.isRunning || SuctionPump2.isRunning} />
